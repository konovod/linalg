...
lib LibCBLAS
  ...
  fun ztrmm = cblas_ztrmm(order : MatrixLayout, side : CblasSide, uplo : CblasUplo, trans_a : CblasTranspose, diag : CblasDiag, m : Blasint, n : Blasint, alpha : LibC::Double*, a : LibC::Double*, lda : Blasint, b : LibC::Double*, ldb : Blasint)
  ...
  fun zhemm = cblas_zhemm(order : MatrixLayout, side : CblasSide, uplo : CblasUplo, m : Blasint, n : Blasint, alpha : LibC::Double*, a : LibC::Double*, lda : Blasint, b : LibC::Double*, ldb : Blasint, beta : LibC::Double*, c : LibC::Double*, ldc : Blasint)
